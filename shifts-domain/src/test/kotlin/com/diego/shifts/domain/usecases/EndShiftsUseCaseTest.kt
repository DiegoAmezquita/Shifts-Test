...
internal class EndShiftsUseCaseTest {
  ...
  private lateinit var useCase: EndShiftsUseCase

  @BeforeEach
  fun setup() {
    useCase = EndShiftsUseCase(repository, getLocationUseCase, getFormattedDeviceTime)
  }

  @Test
  fun `return end shifts message correctly`() {
    ...
    coEvery { repository.endShift(time, location) } returns response
  ...
  @Test
  fun `return end shift passes exception`() {
    val time = "time"
